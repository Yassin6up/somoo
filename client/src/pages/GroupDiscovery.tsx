                ...
                <Card key={group.id} className="hover-elevate">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {group.leader && (
                      <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={group.leader.profileImage} />
                          <AvatarFallback>
                            {group.leader.fullName?.charAt(0) || "?"}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                          <p className="text-sm font-medium">{group.leader.fullName}</p>
                    ...
                    <Link href={`/chat-with-leader/${group.id}`}>
                      <Button className="w-full" variant="default" data-testid="button-browse-projects">
